 ...
 *
 * Modified by Robert L. Read, 2022, to make it includable. 
...
// We will make hex_nut and with covered end to form a cap!
if (type=="cap")
{
	hex_cap(nut_diameter,nut_height,nut_thread_step,nut_step_shape_degrees,nut_thread_outer_diameter,nut_resolution);
}
...
module hex_cap(df,hg,sth,clf,cod,crs)
{

    difference()
    {
        // Rob tries to modify this...      
        // hex_head(hg,df);
        hex_head(hg * 2,df);
